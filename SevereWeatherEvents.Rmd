...
Below we dowload and unzip the storm data from the National Weather Service unless those data have been downloaded and unzipped already.
...
Now let's read the data adn look at the number of variables and measurements (columns and rows). Let's also print out all column names.
