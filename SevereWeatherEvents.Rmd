...
Now that we have the impact data in the proper units, let's find out the mean damage per event type for property and crop damage.
...
Since property damage is in general much higher than crop damage, the total economic damage is similar to the property damage with small changes. For example, excessive wetness, which is the highest-impact event for crops, becomes more important than hurricanes in the total economic impact.

# Summary and Conclusions

We used data from the NOAA severe weather database in order to determine the weather events with the highest health and economic impact. From our study, tornadoes and heat waves are the events with the highest fatalities and injuries. When it comes to economic impact, tornadoes are the ones with the highest property damage, while severe wetness has the largest impact on crops. In average, the highest total economic impact comes from tornadoes.
